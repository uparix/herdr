---
description: SwarmForge Architect agent — operates under the SwarmForge Constitution.
mode: primary
---
...
## Working Directory
/Users/andi/Developer/git/agentic

## Coordination
- You work inside a herdr session named "swarmforge".
- To send a message to another agent, run: `python3 notifier.py <pane> "message"`
  - Pane 0 = Architect
